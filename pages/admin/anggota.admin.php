                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="form-tambah">Form Edit Data Anggota
                                                        </h5>
                                                        <!-- Search -->
                                                    ...
                                                    <form method="post" id="insert_form">
                                                        <div class="modal-body mt-2">
                                                            <div class="form-group mt-2">
                                                                <label for="nip-anggota"
                                                                    style="font-size: 12pt">NIP</label>
                                                                <input type="text" class="form-control" id="nip"
                                                                    name="ubah_anggota" required readonly />
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="nama-anggota"
                                                                    style="font-size: 12pt">Nama</label>
                                        ...
                                        <div class="modal fade" id="modals-hapus" tabindex="-1"
                                            aria-labelledby="modals-hapus" aria-hidden="true" style="text-align: left">
