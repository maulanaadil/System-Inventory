							...
							<tbody>
								...
								<tr>
									...
									<td><?= 
										...
										?></td>
									<td>
									<button type="button" class="btn btn-warning btn-sm me-3 view-edit" id="<?= $data['id_barang'] ?>">Edit</button>
									<!-- MODAL EDIT DATA -->
														...
														<div class="row mt-2">
															<div class="col">
																<div class="form-group">
																	...
																	<div>
																		<select class="form-select" aria-label="Default select example" name="kategori-barang" id="kategori-barang">
														...
														<div class="row">
															<div class="col">
																<div class="form-group">
																	...
																	<div>
																		<select class="form-select" aria-label="Default select example" name="sumber" id="sumber">
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (resp.status === "OK") {
					...
					var total = parseInt(qtyBaik) + parseInt(qtyRusak) + parseInt(qtyRusakBerat);
